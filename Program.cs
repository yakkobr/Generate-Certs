...
namespace GenerateCerts
{
    internal class Program
    {
        ...
        private const string GenerateCertsSerial = "generate-certs-serial";
        private const string GenerateCertsDb = "generate-certs-db";
        private const string GenerateCertsCaConf = "generate-certs-ca.conf";
        private const string GenerateCertsCertsConf = "generate-certs-certs.conf";
            ...
            catch (Exception)
            {
                ...
                if (todo == "1")
                {
                    ...
                    try
                    {
                        ...
                        string OpenSSL_Dir = Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86) + @"\OpenSSL-Win32\bin";
        ...
        san_retry:
            ...
            if (san_line.Length > 0)
            {
                ...
                try
                {
                    string parsedIP = IPAddress.Parse(san_line).ToString();
                    if (parsedIP != null)
